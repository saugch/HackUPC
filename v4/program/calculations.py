...
def ask_me(originplace, destinationplacelist, destinationcountryplacelist, inoutbounddatelist, budget, delta, travellers='1',currency='EUR',friendhome=False, give_me_more=(0,0)):
    ...
    for destinationplace in destinationplacelist[a:]:
        for inoutbounddate in inoutbounddatelist[b:]:
            ...
            if price != None:
                lcosts = 30*int(delta)*int(travellers) #falta arreglar-ho
                n     += 1
